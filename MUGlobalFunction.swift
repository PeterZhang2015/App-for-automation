...
//  App for automation
//
//  Created by Chongzheng Zhang on 2/28/18.
...
/*Add EstimatedTimeArrivalTo etaArray. */
func getEstimatedTimeArrivalAnnotation(_ mapView: MKMapView, route: MKRoute) -> MKAnnotation {
...
func showRouteFromCurrentLocationToDestinationLocation(_ mapView: MKMapView, currentUserAddressCoordinate: CLLocationCoordinate2D, destinationLocationCoordinate: CLLocationCoordinate2D) -> Void {
    ...
    directions.calculate {response, error in
        ...
        //        var etaAnnotationArray = [MKAnnotation]()
        
        for route in unwrappedResponse.routes {
            
            addEstimatedTimeArrivalToRoute(mapView, route: route)
            
            //            let anEtaAnnotaion = getEstimatedTimeArrivalAnnotation(mapView, route: route)
            //
            //            etaAnnotationArray.append(anEtaAnnotaion)
        ...
        //        mapView.addAnnotations(etaAnnotationArray)
...
func addActionForUIAlertController(_ alertController: UIAlertController ,actionTitle: String, actionProcess:@escaping () -> Void) -> Void {
